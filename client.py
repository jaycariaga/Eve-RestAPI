...
#entry_point holds url, demo url works but for some reason not the localhost which was setup via run.py
...
#when running the output, '404' represents no action needed to delete (no element available) and '201' represents successful post; 204 means Delete was successful
